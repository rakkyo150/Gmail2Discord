...
~~そのうち１チャンネルには２つのメールアドレスを登録することができ、もう１チャンネルには３つのメールアドレスを登録することができます。~~(2021/7/21に変更)<br>
...
~~C2,D2~~C2,D2,E3(2021/7/21に変更)とC3,D3,E3には、そのほかのメールとは区別して受け取りたいメールのメールアドレスをそれぞれ追加してください。<br>
C1とD1とE1~~とE2~~(2021/7/21に変更)は空欄になりますが、問題ありません。<br>
